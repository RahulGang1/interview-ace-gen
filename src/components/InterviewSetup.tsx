...
import { Clock, Target, Zap, Brain, Code, Trophy } from 'lucide-react';
        ...
        <div className="w-full max-w-4xl">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Configure your mock interview settings and test your technical skills with AI-powered questions
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <Card className="bg-gradient-to-r from-blue-500 to-blue-600 text-white border-0">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-blue-100">Test your conceptual knowledge</p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-gradient-to-r from-purple-500 to-purple-600 text-white border-0">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-purple-100">Practice real coding problems</p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-gradient-to-r from-green-500 to-green-600 text-white border-0">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-green-100">Get instant performance insights</p>
              </CardContent>
            </Card>
          </div>
          ...
          <Card className="shadow-2xl border-0 bg-white/90 backdrop-blur-sm">
            <CardHeader className="text-center pb-8">
              ...
              <p className="text-gray-600 mt-2">Customize your interview experience</p>
            </CardHeader>
